...
<Note>
This covers the V1 ArbitrableProxy. For V2, the [Dispute Resolver](/legacy/integrate/dispute-resolver) provides a web UI for standalone dispute creation, and the `IDisputeResolver` interface serves a similar role for custom contracts.
</Note>
