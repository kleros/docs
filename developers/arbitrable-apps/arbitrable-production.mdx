...
- [ ] **Contract upgrades:** V2 contracts use UUPS proxy patterns and may be upgraded via governance. Subscribe to the [Kleros blog](https://blog.kleros.io) and [Discord](https://discord.gg/MhXQGCyHd9) for announcements.
...
<Note>
Contact the Kleros team via [Discord](https://discord.gg/MhXQGCyHd9) or `integrations@kleros.io` before your first production deployment. The team can review your dispute template and advise on court selection.
</Note>
...
- [Kleros Discord](https://discord.gg/MhXQGCyHd9) Developer support
