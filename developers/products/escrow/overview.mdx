...
<Steps>
  ...
  <Step title="Web Application">
    React-based frontend for creating and managing transactions at [escrow-v2.kleros.builders](https://escrow-v2.kleros.builders).
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Live Application" icon="rocket" href="https://escrow-v2.kleros.builders">
    Escrow V2 interface
  </Card>
