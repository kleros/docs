...
<Steps>
  ...
  <Step title="Dispute Option">
    The party that did not propose the settlement can raise a dispute immediately by paying the arbitration fee. The proposing party must wait for `settlementTimeout` to elapse before it can raise a dispute.
  </Step>
</Steps>
