...
The Reality.eth + Kleros oracle powers **SafeSnap**, which translates off-chain Snapshot votes into on-chain execution through a Gnosis Safe, with Kleros Court as the arbitration backstop.

See the **[SafeSnap product page](/products/safesnap)** for what it is and how the flow works, and the **[DAO Governance example](/developers/examples/dao-governance)** for setup and configuration.
