...
Most DApp integrations work fine with the standard [Question Resolution Policy](https://ipfs.io/ipfs/QmaUr6hnSVxYD899xdcn2GUVtXVjXoSXKZbce3zFtGWw4H/Question_Resolution_Policy.pdf). In some cases, you may need a custom primary document tailored to your application.
...
- **Content Moderation** — [Moderate / Susie bot](https://kleros.io/moderate) uses it for decentralized content policy enforcement
