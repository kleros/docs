...
Curate Classic is the full Token-Curated Registry, and Light Curate is the simplified, higher-volume variant. Both are on Ethereum and Gnosis Chain, and existing registries remain available for direct integration by third-party developers.
...
<CardGroup cols={2}>
  ...
  <Card title="Discord Community" icon="discord" href="https://discord.gg/MhXQGCyHd9">
