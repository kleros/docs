...
<Note>
A V2 version is available: [Curate V2](/products/curate) on Arbitrum.
</Note>
...
V2 Curate is deployed on Arbitrum with lower gas costs and the same TCR mechanics. Existing V1 registries remain accessible because the V1 contracts stay deployed, but no new Kleros registries will launch on V1 and new lists can no longer be created through Kleros frontends.