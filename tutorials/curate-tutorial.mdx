...
description: "Create a curated list, register it, and submit or challenge items"
---
...
<Frame caption="Create a List, screenshot to be added">
  <img src="/images/v1-screenshot-placeholder.svg" alt="Create a List, screenshot to be added" />
</Frame>
