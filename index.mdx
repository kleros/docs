...
<CardGroup cols={2}>
  <Card title="I want to be a juror" icon="scale-balanced" href="/court">
  ...
  <Card title="I want to build with Kleros" icon="code" href="/developers">
    Integrate dispute resolution into your application
  </Card>
  <Card title="I want to understand Kleros" icon="lightbulb" href="/concepts">
...
<CardGroup cols={3}>
  <Card title="How it works" icon="circle-question" href="/court/overview">
  ...
  <Card title="Integrate Court" icon="plug" href="/developers/arbitrable-apps">
...
<CardGroup cols={2}>
  <Card title="Curate" icon="list-check" href="/products/curate">
    ...
    Decentralized lists & registries</div>
  ...
  <Card title="Scout" icon="shield-check" href="/products/scout">
    <div className="text-sm text-gray-400 mb-2">
    Contract & token verification</div>
  ...
  <Card title="Oracle" icon="database" href="/products/oracle">
    <div className="text-sm text-gray-400 mb-2">
    Reality.eth + Kleros</div>
...
<Tabs>
  <Tab title="New to Kleros?">
    ...
    <Steps>
      <Step title="Understand the architecture">
        ...
        [Read the overview →](/developers/overview)
      </Step>
      ...
      <Step title="Explore examples">
        ...
        [View examples →](/developers/examples)
      </Step>
    </Steps>
  </Tab>
  <Tab title="Build an arbitrable app">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Full integration guide" icon="book" href="/developers/arbitrable-apps/guide">
  ...
  <Tab title="Build on a Kleros product">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Oracle integration" icon="database" href="/developers/products/oracle">
...
<div className="mt-6">
<Card title="Reference: Contract addresses, ABIs, and APIs" icon="book-bookmark" href="/reference">
...
<CardGroup cols={3}>
  ...
  <Card title="Court hierarchy" icon="sitemap" href="/concepts/court-hierarchy">
...
<Note>
  **Research partnership?** Kleros collaborates with universities and research institutions. [Get in touch →](/research/partnerships)
</Note>
...
**Kleros** — Justice as a service

[Website](https://kleros.io) · [GitHub](https://github.com/kleros) · [Twitter](https://twitter.com/klaboradios) · [Blog](https://blog.kleros.io)
