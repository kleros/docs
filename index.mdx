...
<Tabs>
  ...
  <Tab title="Build an arbitrable app">
    ...
    <CardGroup cols={2}>
      <Card title="ERC-792: Arbitration Standard" icon="file-contract" href="/developers/legacy/erc-792">
        The interface your contract needs to implement
      </Card>
      <Card title="ERC-1497: Evidence Standard" icon="file-lines" href="/developers/legacy/erc-1497">
