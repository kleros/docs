...
| [SafeSnap](/products/safesnap) | V1 | 🔄 V2 coming soon |
...
<CardGroup cols={2}>
  ...
  <Card title="SafeSnap" icon="vault" href="/products/safesnap">
    **Trustless DAO execution**
    
    Execute Snapshot vote outcomes against a Gnosis Safe treasury, with Kleros Court as the final arbitrator.
    
    - Snapshot vote → Safe execution
    - Permissionless challenge with bonds
    - Kleros as arbitration backstop
  </Card>
...
| [Curate V1](/legacy/curate-v1) | [Curate V2](/products/curate) available. Curate V1 is being deprecated: existing lists keep working, but no new lists |
