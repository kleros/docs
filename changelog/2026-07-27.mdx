---
title: "July 27, 2026"
description: "Hidden voting and rewards on Scout, Robinhood chain in Scout and Curate classic, Vea Arbitrum–Base SDK route, and Court ruling fixes."
---
...
The dispute creation flow in [Dispute Resolver](/developers/products/dispute-resolver/overview) tightens Sign-In With Ethereum (SIWE) gating on the create form and summary, so authentication prompts appear at the right moments.
