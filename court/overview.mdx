...
| Component | V1 | V2 |
| --- | --- | --- |
| **Network** | Ethereum L1 and Gnosis Chain | Arbitrum L2 |
...
| **Cross-chain** | Separate deployments on Ethereum and Gnosis, no cross-chain relay | Multi-chain via VEA bridge |
